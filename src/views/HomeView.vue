...
.usp__bgr {
  ...
  width: 100%;
  height: 100%;
  background: url(../components/images/bgimg.jpg) center center no-repeat;
...
<script setup>
// const url = "../components/images/bgimg.jpg";
</script>
